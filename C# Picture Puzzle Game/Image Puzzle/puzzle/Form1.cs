...
namespace WindowsFormsApplication1
{
    public partial class frmPuzzleGame : Form
    {
        ...
        private void btnShuffle_Click(object sender, EventArgs e)
        {
            ...
            {
                YesOrNo = MessageBox.Show("Are You Sure To RESTART ?", "Group 1 Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            }
        ...
        {
            DialogResult YesOrNO = MessageBox.Show("Are You Sure To Quit ?", "Group 1 Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
